                ...
                <ul class="space-y-2 pb-2">
                    <li>
                        <form action="#" method="GET" class="lg:hidden">
                            <label for="mobile-search" class="sr-only">Searchese</label>
                            <div class="relative">
                    ...
                    <li>
                        <a href="https://demo.themesberg.com/windster-pro/mailing/inbox/" target="_blank"
                            ...
                            <span
                                class="bg-gray-200 text-gray-800 ml-3 text-sm font-medium inline-flex items-center justify-center px-2 rounded-full">4</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="https://demo.themesberg.com/windster/e-commerce/products/"
                            ...
                            <span class="ml-3 flex-1 whitespace-nowrap">Predefined complains</span>
                        </a>
                    </li>
                </ul>
