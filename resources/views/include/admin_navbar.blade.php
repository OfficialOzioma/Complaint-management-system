        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="https://demo.themesberg.com/windster/" class="text-xl font-bold flex items-center lg:ml-2.5">
                    <img src="https://res.cloudinary.com/ozilo4r/image/upload/c_fit,h_150,q_80/v1661847885/ISM.png" class="h-6 mr-2"
                        alt="Windster Logo">
                    <span class="self-center whitespace-nowrap">EvanTick</span>
                </a>
